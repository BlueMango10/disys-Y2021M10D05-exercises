...
type TimeServiceClient interface {
	GetCurrentTime(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Time, error)
}
...
func (c *timeServiceClient) GetCurrentTime(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Time, error) {
	out := new(Time)
...
type TimeServiceServer interface {
	GetCurrentTime(context.Context, *Empty) (*Time, error)
...
func (UnimplementedTimeServiceServer) GetCurrentTime(context.Context, *Empty) (*Time, error) {
